...
const About = () => {
  return (
    <section className='section'>
      ...
      <p>
        This Task Manager App is a React + Redux based front-end application designed to help users
        manage tasks efficiently. It provides dashboards, boards, Pomodoro timers, and weather widgets
        in one unified platform.
      </p>

      <h2 className='about__header'>Problem Statement</h2>
      <p>
        Managing multiple tasks and keeping track of deadlines can be challenging. Existing tools are
        often too complex or lack flexibility for everyday usage. This project solves the problem by
        providing a lightweight yet powerful task management tool that combines productivity
        features—such as task analytics and Pomodoro timers—with real-world utilities like weather
        tracking.
      </p>

      <h2 className='about__header'>Features</h2>
      <ul className='about__list'>
        <li>📌 <strong>Task Management:</strong> Create, edit, prioritize, and delete tasks.</li>
        <li>📊 <strong>Dashboard:</strong> Track open, closed, missed, today's, and weekly tasks.</li>
        <li>🗂 <strong>Board:</strong> Manage tasks visually, including date & priority editing.</li>
        <li>⏱ <strong>Pomodoro Timer:</strong> Focus timer for productivity cycles.</li>
        <li>🌤 <strong>Weather:</strong> Display current weather with data from OpenWeather API.</li>
        <li>⚙️ <strong>Settings:</strong> Customize Pomodoro and weather preferences.</li>
        <li>🔒 <strong>Login:</strong> (Planned) Implement authentication and user accounts.</li>
      </ul>

      <h2 className='about__header'>Achievements</h2>
      <ul className='about__list'>
        <li>✅ Implemented full Redux store management with persistence via local storage.</li>
        <li>✅ Built an interactive dashboard for quick analytics of user tasks.</li>
        <li>✅ Added Pomodoro timer to integrate productivity techniques.</li>
        <li>✅ Integrated weather data using OpenWeather API.</li>
        <li>✅ Designed modular architecture for future extensions (DB integration, login).</li>
      </ul>
      ...
      <p>
        This will run the app in development mode. Open <code>http://localhost:3000</code> to view
        it in the browser. The page reloads automatically when edits are made.
      </p>

      <h3 className='about__header'>Build</h3>
      <pre><code>npm run build</code></pre>
      <p>
        Builds the app for production into the <code>build</code> folder. It bundles React in
        production mode and optimizes performance.
      </p>

      <h2 className='about__header'>Structure</h2>
      <ul className='about__list'>
        <li><code>src/App.js</code> - Main App component</li>
        <li><code>src/index.js</code> - Entry point rendering App</li>
        <li><code>src/components/</code> - UI components (Tasks, Dashboard, Weather, Pomodoro)</li>
        <li><code>src/slices/</code> - Redux slices for task, pomodoro, and weather state</li>
      ...
      <ul className='about__list'>
        <li>Add user accounts and authentication</li>
        <li>Sync state across devices/users</li>
        <li>Dockerized backend with H2 DB or MongoDB</li>
      </ul>

      <h2 className='about__header'>License</h2>
      <p>
        This project is open source and available under the
        <a href="/path/to/license"> MIT License</a>.
      </p>
    </section>
